...
| ------------- | ------------------ | ----------- |
| [Git Commands](https://github.com/shanelandis/portfolio/blob/main/git%20commands) | Reference | Provides a breakdown of QR codes and what they do. The audience for this document is nonspecialists who do not have an understanding of QR codes. To create this document, I used the [Good Docs Project's]() explanation template.|
